...
//                // Customer endpoints
                                .requestMatchers(GET, "/api/customers").hasAnyRole("ADMIN", "CASHIER")
                                .requestMatchers(GET, "/api/customers/{customerId}").hasAnyRole("ADMIN", "CASHIER")
...
//                // Employee endpoints
                                .requestMatchers(GET, "/api/employees").authenticated()
                                .requestMatchers(GET, "/api/employees/{employeeId}").authenticated()
...
//                // OptionDetail endpoints
                                ...
                                .requestMatchers(POST, "/api/option-details").hasAnyRole("ADMIN")
                                .requestMatchers(PATCH, "/api/option-details/{optionDetailId}").hasAnyRole("ADMIN")
                                .requestMatchers(DELETE, "/api/option-details/{optionDetailId}").hasAnyRole("ADMIN")
...
//                // Payment endpoints
                                ...
                                .requestMatchers(POST, "/api/payments/session-notify").permitAll()
//                // ServiceRequest endpoints
                                .requestMatchers(GET, "/api/service-requests").permitAll()
                                .requestMatchers(GET, "/api/service-requests/{serviceRequestId}").permitAll()
                                .requestMatchers(POST, "/api/service-requests").permitAll()
                                .requestMatchers(PATCH, "/api/service-requests/{serviceRequestId}/handle").hasAnyRole("CASHIER")
...
//                // Session endpoints
                                ...
                                .requestMatchers(PATCH, "/api/sessions/{sessionId}").hasAnyRole("ADMIN", "CASHIER")
                                .requestMatchers(POST, "/api/sessions/{sessionId}/end").hasAnyRole("ADMIN", "CASHIER")
                                .requestMatchers(DELETE, "/api/sessions/{sessionId}").hasAnyRole("ADMIN")
//                // Tables endpoints
